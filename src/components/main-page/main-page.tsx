  ...
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        <Link className={styles.link} to="/algososh/recursion">
          <div className={`${styles.card} ${styles.string}`} />
        </Link>
        <Link className={styles.link} to="/algososh/fibonacci">
          <div className={`${styles.card} ${styles.fibonacci}`} />
        </Link>
        <Link className={styles.link} to="/algososh/sorting">
          <div className={`${styles.card} ${styles.arr}`} />
        </Link>
        <Link className={styles.link} to="/algososh/stack">
          <div className={`${styles.card} ${styles.stack}`} />
        </Link>
        <Link className={styles.link} to="/algososh/queue">
          <div className={`${styles.card} ${styles.queue}`} />
        </Link>
        <Link className={styles.link} to="/algososh/list">
